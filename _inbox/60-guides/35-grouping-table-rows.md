...
![Applying Block Repetition to Table Body](/assets/guides/UniqueListIntoBlockRepetition.gif)
...
![Applying Block Repetition to Table Body](/assets/guides/FilterListInSecondRepetition.gif)
...
![Applying Block Repetition to Table Body](/assets/guides/TableGroupingInputFields.png)

## Test run

When we create document from our template we should get our items grouped by a team.

![Applying Block Repetition to Table Body](/assets/guides/TableGroupingTestRun.png)
