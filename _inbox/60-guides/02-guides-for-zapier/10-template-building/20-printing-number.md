...
To print a number value ​​from make.com, follow these steps:
...
- Type the word you want to represent the value. This word cannot contain a space. For example **Quantity**.
...
![image](/assets/guides/NumberPrintingMake1.gif)

![image](/assets/guides/ZapierPrintingNumber.gif)