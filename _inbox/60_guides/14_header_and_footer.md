...
![Creating 3 row table for header and footer concept](/assets/guides/CreateTable.gif)
...
![Setting first and last row height to a constant](/assets/guides/RowHeight.gif)
...
![Placing header text and footer page numbering](/assets/guides/PageNumbers.gif)
...
![Removing table's borders by setting their size to 0](/assets/guides/RemoveTableBorders.gif)
...
![Increasing Main document's page top and bottom margin](/assets/guides/IncreasePageMargin.gif)
