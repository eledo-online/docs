...
| custom_column | item.custom_column | Item's custom column (text) <br> - replace *custom_column* with your column's technical name |
...
| custom_column | custom_column | Subitem's custom column (text) <br> - replace *custom_column* with your column's technical name |
