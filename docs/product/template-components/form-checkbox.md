...
Define a simple boolean field name or formula using the [expression language](../template-building-guides/expressions.md) to be evaluated and printed into the document.
