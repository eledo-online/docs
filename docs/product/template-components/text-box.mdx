...
For a complete reference of all supported patterns, see [**Formatting Dates**](../template-building-guides/formatting-dates.mdx).
...
- Learn how expressions work → [Expressions](../template-building-guides/expressions.mdx)
- Learn how to format values → [Printing Text](../template-building-guides/printing-text.mdx)
