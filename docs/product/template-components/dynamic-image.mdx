...
Define a simple field name or formula using the [expression language](../template-building-guides/expressions.mdx) to be evaluated as image URL or image data.
