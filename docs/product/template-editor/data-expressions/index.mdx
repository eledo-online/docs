...
sidebar_position: 1
description: "Learn how Eledo Data Expressions use variables, operators, functions, and type resolution to compute dynamic values in PDF templates."
keywords:
...
Eledo automatically prepares input fields from your template and inserts values into the generated PDF based on data provided via [API](/docs/api/index.mdx). Data Expressions are used in both steps — they define which input fields are created and how the data is processed and displayed.
