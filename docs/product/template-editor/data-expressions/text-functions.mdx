...
sidebar_position: 4
description: "Use Eledo Text Functions to concatenate, transform, search, split, replace, and extract text values in template expressions."
keywords:
  - Eledo Text Functions
  - text expressions
  - CONCAT function
  - REGEX function
  - text formatting
