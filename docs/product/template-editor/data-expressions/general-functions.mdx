...
sidebar_position: 3
description: "Use Eledo General Functions for conditional logic, defaults, counters, object properties, arrays, and phone number values in template expressions."
keywords:
  - Eledo General Functions
  - IF function
  - SWITCH function
  - DEFAULT function
  - NEXTCOUNTER
