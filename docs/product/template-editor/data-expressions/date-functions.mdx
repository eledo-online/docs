...
sidebar_position: 6
description: "Use Eledo Date Functions to format, parse, compare, and calculate dates in template expressions and generated PDF documents."
keywords:
  - Eledo Date Functions
  - date formatting
  - date parsing
  - date arithmetic
  - working days
