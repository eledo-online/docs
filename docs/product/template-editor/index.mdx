...
<figure>
![image](/img/product/template-editor/template-editor.png)
<figcaption>*Template Editor with a sample document.*</figcaption>
</figure>
...
You build your document directly on the page, just like in a text editor:
...
- place components directly into the layout  
...
These components allow you to insert dynamic content and logic into your document.
...
The component is placed exactly at the cursor position.
