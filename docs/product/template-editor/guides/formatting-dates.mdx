...
sidebar_position: 5
description: "Learn how to format dates in Eledo templates using DATE(), Java-style date patterns, timezones, and locale-aware output."
keywords:
  - Eledo date formatting
  - DATE function
  - Java date patterns
...
You can [control how dates appear](../data-expressions/date-functions.mdx) in your document — for example displaying them as `25.02.2023`, `2023-02-25`, or including time.
