...
sidebar_position: 7
description: "Learn how to create headers and footers in Eledo using Background documents, page layout tables, margins, and page number variables."
keywords:
  - Eledo header and footer
  - Background document
  - page layout
  - page numbers
  - PDF margins
