...
sidebar_position: 4
description: "Learn how to format numbers and currency values in Eledo templates using NUM(), CURR(), locale settings, and rounding."
keywords:
  - Eledo number formatting
  - NUM function
  - CURR function
  - currency formatting
  - locale settings
...
Eledo provides two functions for [number formatting](../data-expressions/number-functions.mdx):
...
- See [**Printing Text**](./printing-text.mdx) for combining numbers with text
- See [**Formatting Dates**](./formatting-dates.mdx) for date formatting  
