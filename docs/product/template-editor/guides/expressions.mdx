...
title: Expressions
sidebar_position: 2
description: "Learn how to use Eledo Expressions to insert data, transform values, perform calculations, and generate dynamic content in templates."
keywords:
  - Eledo Expressions
...
[Expressions](../data-expressions/index.mdx) allow you to define dynamic values in your template.
...
Expressions are used throughout the [template editor](../index.mdx) — for example in text, form fields, dynamic images, and file names.
