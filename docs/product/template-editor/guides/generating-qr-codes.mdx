...
sidebar_position: 11
description: "Learn how to generate QR codes in Eledo templates by encoding URLs, text, contacts, Wi-Fi details, events, and structured data."
keywords:
  - Eledo QR codes
  - QR Code component
  - 2D Barcode
...
You can generate QR codes in your document using the [**2D Barcode → QR Code**](../components/barcodes/2d.mdx) component.
...
- 2D Barcodes → [2D Barcodes](../components/barcodes/2d.mdx)  
