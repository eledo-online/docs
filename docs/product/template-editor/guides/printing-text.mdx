...
title: Printing Text
sidebar_position: 3
description: "Learn how to print dynamic text in Eledo templates using Text Box expressions, field values, formatting, CONCAT(), and the + operator."
keywords:
  - Eledo Printing Text
  - Text Box
  - dynamic text
...
A [**Text Box**](../components/text-box.mdx) allows you to insert dynamic values into your document — such as names, prices, dates, or calculated values.
...
This value is then filled in when generating the document through integrations ([Make](/docs/integrations/make/index.mdx), [Zapier](/docs/integrations/zapier/index.mdx), [API](/docs/api/index.mdx), etc.).

:::tip

Learn more about the component itself: [Text Box](../components/text-box.mdx)
...
![Formatting text using expression](/img/product/template-editor/components/formatting-text-example.png)
...
- Learn how Text Box works → [Text Box](../components/text-box.mdx)
