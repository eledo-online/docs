...
![Applying Block Repetition to Table Body](/img/product/guides/InlineImagesDefineStyle.gif)
...
![Applying Block Repetition to Table Body](/img/product/guides/InlineImagesAddDynamicImage.gif)
...
![Applying Block Repetition to Table Body](/img/product/guides/InlineImagesWrapWithDIVContainer.gif)
...
![Applying Block Repetition to Table Body](/img/product/guides/InlineImagesApplyBlockRepetition.gif)

## Test run
When we create document from our template we should get a result like this

![Applying Block Repetition to Table Body](/img/product/guides/InlineImagesTestRun.png)
...
![Applying Block Repetition to Table Body](/img/product/guides/InlineImagesConstantHeight.png)

Now it looks much better even with more images:

![Applying Block Repetition to Table Body](/img/product/guides/InlineImagesTestRun2.png)
