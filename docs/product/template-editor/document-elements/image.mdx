...
title: Image
sidebar_position: 2
description: "Use Image in the Eledo Template Editor to insert static logos, branding assets, decorative graphics, and linked images into PDF templates."
keywords:
  - Eledo Image
  - static image
  - PDF images
...
Use [Dynamic Image](../components/dynamic-image.mdx) when:
