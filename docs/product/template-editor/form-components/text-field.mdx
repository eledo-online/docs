...
title: Text Field
sidebar_position: 2
description: "Use Text Field in the Eledo Template Editor to add single-line PDF input fields that can be prefilled and edited by users."
keywords:
  - Eledo Text Field
  - PDF text field
  - single-line input
...
<ImageWithCaption
  src="/img/product/template-editor/form-components/text-field-configuration.png"
  alt="Text Field Configuration"
  caption="Text Field configuration dialog."
/>
...
<ImageWithCaption
  src="/img/product/template-editor/form-components/text-field-toolbar.png"
  alt="Text Field in Form dropdown"
  caption="Select Text Field from the Form dropdown."
/>
