...
title: Checkbox
sidebar_position: 4
description: "Use Checkbox in the Eledo Template Editor to add interactive PDF checkbox fields that can be prefilled from data and edited by users."
keywords:
  - Eledo Checkbox
  - PDF checkbox field
  - interactive PDF
...
- Learn about conditional display → [Block Condition](../components/block-condition.mdx)
