...
title: Select
sidebar_position: 5
description: "Use Select in the Eledo Template Editor to add interactive PDF dropdown fields with predefined options and preselected values."
keywords:
  - Eledo Select
  - PDF dropdown field
  - interactive PDF
...
<ImageWithCaption
  src="/img/product/template-editor/form-components/select-configuration.png"
  alt="Select Configuration"
  caption="Select configuration dialog."
/>
...
<ImageWithCaption
  src="/img/product/template-editor/form-components/select-toolbar.png"
  alt="Select in Form dropdown"
  caption="Select Select from the Form dropdown."
/>
