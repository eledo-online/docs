...
sidebar_position: 6
description: "Use Dynamic Checkbox in the Eledo Template Editor to insert checkboxes that are checked or unchecked based on data or expressions."
keywords:
...
<ImageWithCaption
  src="/img/product/template-editor/components/dynamic-checkbox-configuration.png"
  alt="Dynamic Checkbox configuration"
  caption="Dynamic Checkbox configuration dialog."
/>
