...
title: Dynamic Image
sidebar_position: 5
description: "Use Dynamic Image in the Eledo Template Editor to insert images from URLs or Base64 data into generated PDF documents."
keywords:
  - Eledo Dynamic Image
  - dynamic images
  - image URL
...
Unlike [Image](../document-elements/image.mdx), which is static, Dynamic Image is evaluated during document generation and can change for each document.

:::tip
Use **[Image](../document-elements/image.mdx)** for static visuals configured in the template.
...
<ImageWithCaption
  src="/img/product/template-editor/components/dynamic-image-configuration.png"
  alt="Dynamic Image Configuration"
  caption="Dynamic Image configuration dialog."
/>
...
- Control layout with other components → [Components](./index.mdx)
