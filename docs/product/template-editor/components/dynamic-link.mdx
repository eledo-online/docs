...
title: Dynamic Link
sidebar_position: 7
description: "Use Dynamic Link in the Eledo Template Editor to insert hyperlinks with dynamic URLs, display text, and styling in generated PDFs."
keywords:
  - Eledo Dynamic Link
  - dynamic hyperlinks
  - personalized URLs
...
<ImageWithCaption
  src="/img/product/template-editor/components/dynamic-link-configuration.png"
  alt="Dynamic Link Configuration"
  caption="Dynamic Link configuration dialog."
/>
