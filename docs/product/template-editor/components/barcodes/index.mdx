...
title: Barcodes
sidebar_position: 1
description: "Use Barcodes in the Eledo Template Editor to add 1D and 2D machine-readable codes for identifiers, URLs, payments, and logistics."
keywords:
  - Eledo Barcodes
  - 1D barcodes
  - 2D barcodes
...
- [**1D Barcodes**](./1d.mdx) (linear)
- [**2D Barcodes**](./2d.mdx) (matrix)
