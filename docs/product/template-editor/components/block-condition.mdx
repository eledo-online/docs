...
sidebar_position: 4
description: "Use Block Condition in the Eledo Template Editor to show or hide document sections based on expressions and input data."
keywords:
  - Eledo Block Condition
  - conditional content
