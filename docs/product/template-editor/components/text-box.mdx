...
title: Text Box
sidebar_position: 2
description: "Use Text Box in the Eledo Template Editor to insert dynamic text, formatted values, dates, HTML, and calculated output into PDF templates."
keywords:
  - Eledo Text Box
  - dynamic text
...
- [**Font**](../editor-tools/fonts-and-styles.mdx) → controls font size
- [**Color**](../editor-tools/basic-formatting.mdx) → controls text color
