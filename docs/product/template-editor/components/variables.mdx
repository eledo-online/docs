...
title: Variables
sidebar_position: 10
description: "Use Variables in the Eledo Template Editor to insert automatically generated values such as page numbers and total pages."
keywords:
  - Eledo Variables
  - page numbers
  - total pages
...
- Control pagination → [Page Break](../document-elements/page-break.mdx)
- Structure content → [Table](../document-elements/table.mdx)
