...
sidebar_position: 3
description: "Use Block Repetition in the Eledo Template Editor to repeat document sections, table rows, or lists based on array data."
keywords:
...
<ImageWithCaption
  src="/img/product/template-editor/components/block-repetition-configuration.png"
  alt="Block Repetition Configuration"
  caption="Block Repetition configuration dialog."
/>
