...
title: Styles Mode
sidebar_position: 12
description: "Use Styles Mode in the Eledo Template Editor to define global CSS styles for consistent fonts, colors, spacing, and PDF design."
keywords:
  - Eledo Styles Mode
  - CSS styles
  - global styling
...
This is an advanced feature intended for users familiar with [CSS](https://developer.mozilla.org/en-US/docs/Web/CSS).
...
- [Basic Formatting](./basic-formatting.mdx) — applies inline styles
- [Fonts & Styles](./fonts-and-styles.mdx) — controls text formatting in the editor
- [Div Container](./create-div-container.mdx) — allows grouping elements for styling
