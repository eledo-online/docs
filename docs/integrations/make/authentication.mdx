...
sidebar_position: 2
description: "Learn how to authenticate the Eledo Make integration using an API key, create a reusable Make connection, and fix credential errors."
keywords:
  - Eledo Make authentication
  - Make API key
  - Eledo API key
  - Make connection
...
Authentication allows [Make](https://www.make.com/) to securely communicate with your Eledo account.
...
Make usually tests the connection when you create it. If the API key is valid, the connection is saved and becomes available for selection. If not, Make displays an error message explaining the issue.
