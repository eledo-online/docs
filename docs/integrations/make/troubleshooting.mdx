...
sidebar_position: 6
description: "Troubleshoot common Eledo Make issues, including authentication errors, empty PDF fields, missing output data, and scenarios that do not run."
keywords:
  - Eledo Make troubleshooting
  - Make authentication
  - empty PDF fields
  - Make output data
  - scenario execution
...
This section covers the most common issues encountered when using the Eledo module in [Make](https://www.make.com/).
...
Refer to the **[Authentication](./authentication.mdx)** section for detailed setup instructions.
...
Review the **[Data Input](./data-input.mdx)** section to confirm proper field mapping.
