...
title: Data Output
sidebar_position: 4
description: "Learn how to use Eledo Make output from Generate PDF and Prepare PDF Download URL actions in later modules and destination workflows."
keywords:
  - Eledo Make output
  - Make file output
  - Generate PDF
...
Eledo provides two actions in [Make](https://www.make.com/):
...
The download URL is single-use. After the first download, it becomes invalid.
