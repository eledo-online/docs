...
- If you need to format this value, try one of our [DATE functions](/docs/product/template-building-guides/formatting-dates.md)
...
Date formatting letters are listed in this article: [Formatting Dates](/docs/product/template-building-guides/formatting-dates.md)
...
Find more information about data formatting in this article: [Formatting Dates](/docs/product/template-building-guides/formatting-dates.md) 

Discover all date functions here: [Date Functions](/docs/product/data-expressions/date-functions.md)
