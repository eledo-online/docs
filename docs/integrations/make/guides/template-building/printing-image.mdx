...
sidebar_position: 6
description: "Learn how to print dynamic images in Eledo templates using Make data mapping, public image URLs, and Dynamic Image components."
keywords:
  - Eledo Make printing image
  - Make image mapping
  - Dynamic Image
  - image URL
  - public image URL
...
This guide shows how to print images into your PDF using [Make](https://www.make.com/).
