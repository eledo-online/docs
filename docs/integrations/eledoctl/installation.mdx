...
title: Installation
sidebar_position: 2
description: "Learn how to install eledoctl with uv or pip, upgrade the CLI, verify the command, and use it for terminal-based PDF generation."
keywords:
  - eledoctl installation
  - Eledo CLI
  - uv tool install
  - pip install
