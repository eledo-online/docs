...
title: Output Modes
sidebar_position: 5
description: "Learn how to use Eledo n8n output modes, including File and Base64, binary PDF data, JSON output, and downstream node expressions."
keywords:
  - Eledo n8n output modes
  - n8n binary data
  - Base64 PDF
  - File mode
  - PDF output
