...
title: Overview
sidebar_position: 1
description: "Learn how the Eledo n8n community node generates PDF documents from n8n workflows using templates, mapped data, guided fields, and JSON mode."
keywords:
  - Eledo n8n integration
  - n8n community node
  - n8n PDF generation
  - PDF automation
  - guided fields
...
This is the official integration of Eledo into the [n8n](https://n8n.io/) ecosystem.
...
* [Installation](./installation.mdx) on both hosted n8n and self‑hosted instances
* [Authentication setup](./authentication.mdx)
* [Guided fields](./data-input/guided-fields.mdx) (recommended for most users)
* [JSON mode](./data-input/json-mode.mdx) (for advanced control)
* Working with [returned data](./output-modes.mdx)
