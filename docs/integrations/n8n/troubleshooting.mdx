...
sidebar_position: 7
description: "Troubleshoot common Eledo n8n issues, including authentication errors, empty PDFs, JSON payload problems, and missing community nodes."
keywords:
  - Eledo n8n troubleshooting
  - n8n authentication
  - empty PDF fields
  - JSON errors
  - guided fields
...
Refer to the **[Authentication](./authentication.mdx)** documentation for full setup instructions.
...
Review the **[Guided Fields](./data-input/guided-fields.mdx)** and **[JSON Mode](./data-input/json-mode.mdx)** sections to confirm proper data mapping.
...
Refer to the **[Installation](./installation.mdx)** section for detailed instructions.
