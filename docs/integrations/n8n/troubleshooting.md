...
Refer to the **[Authentication](./authentication.md)** documentation for full setup instructions.
...
Review the **[Guided Fields](./data-input/guided-fields.md)** and **[JSON Mode](./data-input/json-mode.md)** sections to confirm proper data mapping.
...
Refer to the **[Installation](./installation.md)** section for detailed instructions.
