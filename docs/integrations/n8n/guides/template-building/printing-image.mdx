...
sidebar_position: 6
description: "Learn how to print dynamic images in Eledo templates using n8n Guided Fields, public image URLs, and Dynamic Image components."
keywords:
  - Eledo n8n printing image
  - n8n image mapping
  - Guided Fields
  - Dynamic Image
  - image URL
