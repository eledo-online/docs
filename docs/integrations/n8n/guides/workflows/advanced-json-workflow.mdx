...
sidebar_position: 4
description: "Build an advanced Eledo n8n workflow using JSON Mode, structured payloads, nested objects, Google Sheets data, and Google Drive storage."
keywords:
  - Eledo n8n JSON workflow
