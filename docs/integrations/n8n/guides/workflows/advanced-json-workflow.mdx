...
> **Note:** JSON mode is intended for advanced users. If you are working with simple templates, read the **[Guided Fields](../../data-input/guided-fields.mdx)** documentation first.
