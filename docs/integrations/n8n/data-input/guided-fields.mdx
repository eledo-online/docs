...
title: Guided Fields
sidebar_position: 2
description: "Learn how to use Guided Fields in the Eledo n8n node for simple flat templates with text, number, boolean, and date inputs."
keywords:
  - Eledo n8n Guided Fields
  - n8n field mapping
  - flat templates
  - text fields
  - boolean fields
...
Refer to the [**JSON Input Mode**](./json-mode.mdx) documentation for detailed instructions.
