...
title: Data Input
sidebar_position: 1
description: "Learn how to send data into Eledo n8n templates using Guided Fields for simple inputs or JSON Mode for structured payloads."
keywords:
  - Eledo n8n data input
  - Guided Fields
  - JSON Mode
  - structured payloads
  - n8n templates
