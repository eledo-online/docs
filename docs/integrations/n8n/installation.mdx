...
title: Installation
sidebar_position: 2
description: "Learn how to install the verified Eledo n8n community node on n8n Cloud or self-hosted instances, including UI, manual, and version-pinned installation."
keywords:
  - Eledo n8n installation
  - n8n community node
...
n8n supports [**community nodes**](https://docs.n8n.io/integrations/community-nodes/installation/) — extensions developed outside of the core n8n project.
