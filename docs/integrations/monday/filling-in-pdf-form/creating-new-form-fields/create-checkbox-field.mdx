...
- For Data (expression) field find and select a Checkbox Column using the Fields navigation menu. You can also use any [Eledo function](/docs/product/template-editor/data-expressions/general-functions.mdx).
