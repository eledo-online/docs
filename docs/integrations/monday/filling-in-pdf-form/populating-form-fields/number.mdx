...
- If you need to format this value, try one of our [number formatting functions](/docs/product/template-editor/data-expressions/number-functions.mdx) such as [CURR](/docs/product/template-editor/guides/formatting-numbers.mdx) or [NUM](/docs/product/template-editor/guides/formatting-numbers.mdx) 
...
Find more information about number formatting in this article: [Formatting Numbers](/docs/product/template-editor/guides/formatting-numbers.mdx)

Discover all the number functions here: [Number Functions](/docs/product/template-editor/data-expressions/number-functions.mdx)
