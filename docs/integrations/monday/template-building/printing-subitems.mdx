...
sidebar_position: 3
description: "Learn how to print monday.com subitems in Eledo templates using Block Repetition, repeated table rows, list items, paragraphs, and subitem fields."
keywords:
  - printing subitems
  - monday.com subitems
