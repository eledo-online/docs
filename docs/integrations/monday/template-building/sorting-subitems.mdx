...
Result of SORT function is a sorted list. To print that list we use Block Repetition. How to setup the Block Repetition we describe in [Printing Subitems](./printing-subitems.mdx) guide.
