...
sidebar_position: 8
description: "Learn how to filter monday.com subitems in Eledo templates using the FILTER function, conditions, logical operators, and Block Repetition."
keywords:
  - filtering subitems
  - Eledo FILTER function
  - monday.com subitems
  - Block Repetition
  - logical conditions
  - AND OR functions
