...
sidebar_position: 3
description: "Learn how to generate one Eledo PDF from multiple monday.com items using the items variable, Block Repetition, tables, and multi-item recipes."
keywords:
  - monday.com multiple items
