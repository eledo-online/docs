...
title: Overview
sidebar_position: 1
description: "Learn how the Eledo Zapier integration generates PDF documents from Zap workflows, mapped data, templates, and automation steps."
keywords:
...
Eledo offers official support for [Zapier](https://zapier.com/). The Eledo app is already available on the platform—there is nothing to install.

A typical flow is straightforward:

1. Create a new Zap (Zapier calls an automation workflow a “Zap”).
2. Select an app that produces a trigger event—for example, [Google Sheets](https://zapier.com/apps/google-sheets/integrations).
3. Add Eledo as an action step.
4. In Eledo, select a template and map your input fields.
5. Optionally, add more steps—for example, upload the generated PDF to [Google Drive](https://zapier.com/apps/google-drive/integrations) or send it by email.
...
* [Data input](./data-input.mdx)
* [Data output](./data-output.mdx)
* [Limitations and troubleshooting](./troubleshooting.mdx)
* Step-by-step [guides](./guides/index.mdx) for common scenarios
