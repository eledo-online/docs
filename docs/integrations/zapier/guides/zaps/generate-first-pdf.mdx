...
sidebar_position: 2
description: "Build your first Eledo Zapier automation to generate PDFs from Google Sheets data and upload the generated files to Google Drive."
keywords:
  - Eledo Zapier tutorial
...
Configuration of Google Sheets and Google Drive authentication is outside the scope of this guide. Refer to official Zapier documentation for basic setup.
