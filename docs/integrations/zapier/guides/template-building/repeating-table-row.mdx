...
sidebar_position: 5
description: "Learn how to repeat table rows in Eledo templates using Zapier data mapping, array fields, Block Repetition, and item properties."
keywords:
  - Eledo repeating table row
  - Zapier array mapping
  - Block Repetition
  - dynamic tables
  - item lists
  - PDF templates
