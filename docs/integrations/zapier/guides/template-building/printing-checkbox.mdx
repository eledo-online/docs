...
- Type the word you want to represent the value. This word cannot contain a space. For example **Fragile**.
...
![image](/img/integrations/zapier/ZapierPrintingCheckbox.gif)
