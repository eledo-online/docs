...
title: List
sidebar_position: 2
description: "Use the Eledo List endpoint to retrieve available templates, including scope filtering, limits, template metadata, and observed API behavior."
keywords:
  - Eledo List endpoint
  - template list API
  - Eledo templates
...
- Retrieve schema → [Schema](./schema.mdx)
