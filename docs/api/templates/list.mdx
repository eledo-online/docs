...
- If `scope` is not provided, only **private templates** are returned  
- Using `scope=public` returns a larger set of templates  

**Recommendation:** Always specify `scope` explicitly
