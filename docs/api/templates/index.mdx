...
title: Templates
sidebar_position: 1
description: "Explore the Eledo Templates API for listing available templates and retrieving schema definitions for dynamic forms and integrations."
keywords:
  - Eledo templates API
  - template list
  - template schema
...
Returns a list of available templates accessible by the [authenticated](../authentication.mdx) API key.
