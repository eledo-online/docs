...
title: Download
sidebar_position: 4
description: "Use the Eledo Download endpoint to retrieve generated PDF documents from stored files in asynchronous document workflows."
keywords:
  - Eledo Download endpoint
  - PDF download API
...
Downloads a PDF document created using the [**Create File**](./create-file.mdx) endpoint.
...
1. Create a file using [**Create File**](./create-file.mdx)
...
- you are using the [**Create File**](./create-file.mdx) workflow  
