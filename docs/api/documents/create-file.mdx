...
title: Create File
sidebar_position: 2
description: "Use the Eledo Create File endpoint to store template input data and prepare PDF documents for asynchronous download workflows."
keywords:
  - Eledo Create File endpoint
...
This endpoint is typically used together with [**Download**](./download.mdx) for asynchronous document generation.
